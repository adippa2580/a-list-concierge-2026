    ...
    <footer className="bg-zinc-900 border-t border-zinc-800 py-8 px-4">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4 text-center text-sm">
          ...
          <div className="space-y-2">
            <h4 className="text-gray-400">Support</h4>
            <ul className="space-y-1 text-gray-500">
          ...
          <div className="space-y-2">
            <h4 className="text-gray-400">Legal</h4>
            <ul className="space-y-1 text-gray-500">
        ...
        <div className="flex justify-center gap-6">
          ...
          <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gold transition-colors" aria-label="GitHub">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
